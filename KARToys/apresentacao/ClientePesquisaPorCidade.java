...
public class ClientePesquisaPorCidade extends JDialog {
	...
	public ClientePesquisaPorCidade(JFrame pai) {
		super(pai, "Pesquisa de Clientes por Cidade", ModalityType.MODELESS);
	...
	private void desenhaTela() {
		...
		layout.setHorizontalGroup(layout.createParallelGroup()
				.addGroup(layout.createSequentialGroup()
						...
						.addGroup(layout.createParallelGroup(Alignment.LEADING)
								.addComponent(txtCidade, 300, 300, 300)
						)
						.addGroup(layout.createParallelGroup(Alignment.LEADING)
	...
	private void registraEventos() {
		...
		txtCidade.getDocument().addDocumentListener(new DocumentListener() {
			@Override
			public void removeUpdate(DocumentEvent arg0) {
				txtCidade_TextChanged();
			}
	...
	private void txtCidade_FocusLost() {
		if (txtCidade.getText().trim().isEmpty()) {
			lblStatus.setText("ATENÇÃO: Informe o nome da cidade a ser pesquisada.");
	...
	private void txtCidade_TextChanged() {
	...
	private void populaTabelaCliente() {
		try {
			...
			modelo.setResultSet(clienteP.PesquisaCompletaPorCidade(txtCidade.getText()));
			setTamanhoGrid();
	...
	private static void criaExibeGUI() {
		JDialog clientePesquisaPorCidade = new ClientePesquisaPorCidade(null);
